...
var loadimg = e('main_visual_img').getElementsByTagName('img') 
var loadimgurl = new Array(); 
var maxNum = loadimg.length
for(i=0;i<maxNum;i++){
	loadimgurl[i] = loadimg[i].src
}
function visual_change_fc(){
	...
	main_visual_img.innerHTML ="<img src='"+loadimgurl[nextNum-1]+"' alt='"+vName[nextNum-1][1]+"' style='filter:alpha(opacity="+popNum+");opacity:"+popNum*0.01+";position:absolute'><img src='"+loadimgurl[imgNum-1]+"' alt='"+vName[imgNum-1][1]+"' style='filter:alpha(opacity="+mopNum+");opacity:"+mopNum*0.01+";'>"
	if(popNum > 100){
		popNum = 100;
		mopNum = 0;
		main_visual_img.innerHTML ="<img src='"+loadimgurl[nextNum-1]+"' alt='"+vName[nextNum-1][1]+"' style='filter:alpha(opacity="+popNum+");opacity:"+popNum*0.01+"'>"
