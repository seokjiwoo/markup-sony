				...
				<div class="studio_all" id="reS_01">
						...
						<div class="studio_imgbox">
								...
								<div class="studio_info" id="st_info">
										<ul>
												<li>
														<span>스튜디오 소개</span>
														<span>
															Sony 스튜디오는 패션, 광고, 잡지, 방송, 영화 등의 창조적인 작업을 할 수 있는 공간으로 각종 프로그램 및 연출을 할 수 있는 공간입니다.
														</span>
												</li>
												<li>
														<span>스튜디오 기본환경</span>
														<span>
															총면적 넓이 7M, 높이 4M, 폭 5.5M의 대형 호리존, 초고속 인터넷 미팅룸 제공
														</span>
												</li>
												<li class="last">
														<span>대여가능 장비</span>
														<span>카메라, 렌즈, 탑라이트, 삼각대, 텅스텐조명, 동조기</span>
												</li>
										</ul>
										<p>
								...
								<div class="show_coex_info">
										<div class="coex_left">
												<p>스튜디오 소개</p>
												<p>Sony 스튜디오는 패션, 광고, 잡지, 방송, 영화 등의 창조적인 작업을 할 수 있는 공간으로 각종 프로그램 및 연출을 할 수 있는 공간입니다.</p>
										</div>
										<div class="coex_left">
												<p>스튜디오 기본환경</p>
												<p>총면적 넓이 7M, 높이 4M, 폭 5.5M의 대형 호리존, 초고속 인터넷 미팅룸 제공</p>
										</div>
										<div class="coex_left last">
												<p>대여가능 장비</p>
												<p>카메라, 렌즈, 탑라이트, 삼각대, 텅스텐조명, 동조기 </p>
										</div>
										<div class="btn">
											<a href="#"><img src="/webroot/images/academy/reserv_btn.png" alt="예약신청" /></a>
											<a href="#"><img src="/webroot/images/academy/reserv_can_btn.png" alt="예약취소" /></a>
