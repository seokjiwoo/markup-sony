		...
		<div class="movies_tab_list" id="reS_03">
				<div class="gallery_body st2" id="gallery_body_1">
						...
						<div class="gallery_box on">
								...
								<div class="textbox">
										<a href="#"><div class="ctrec"><img alt="하트 아이콘" src="/webroot/images/newsnevent/selca_ico_a_on.png"/>추천<strong>128</strong></div></a>
										<a href="#"><div class="ctcha"><img alt="글쓰기 아이콘" src="/webroot/images/newsnevent/selca_ico_b_on.png"/>수정</div></a>
								</div>
						</div>
						<div class="gallery_box off">
								<div><img alt="이벤트 썸네일 이미지" src="/webroot/images/gallery/img_gallery_media_sum.png"/></div>
