...
<div id="event_contest">
		...
		<div id="reS_02"class="scrap">
				<div class="title">
						<h3>셀카 콘테스트<br/>참여하기</h3>
				</div>
				<div class="regist">
						<dl>
								<dt>성명</dt>
								...
								<dt>현주거지 주소</dt>
								<dd class="change comment_con"><label for="address">현주거지 주소</label><input disabled="disabled" id="address" type="text"/></dd>
								<dt>사용 카메라</dt>
								<dd>
									<div class="mgr5" id="select_box">
                                            <div class="input_tab contest">
                                                    ...
                                                    <ul class="list" id="select_prodgeoup">
                                                            <li><a href="javascript:list_fc('media','제품군')">제품군</a></li>
                                                            <li><a href="javascript:list_fc('media','dslt')">dslt</a></li>
                                                            <li><a href="javascript:list_fc('media','nex')">nex</a></li>
                                                    </ul>
                                            </div>
									</div>
									<div id="select_box">
                                            <div class="input_tab contest">
                                                    ...
                                                    <ul class="list" id="select_prodlist">
                                                            <li><a href="javascript:list_fc('media','제품명')">제품명</a></li>
                                                            <li><a href="javascript:list_fc('media','a58')">a58</a></li>
                                                            <li><a href="javascript:list_fc('media','nex-f3')">nex-f3</a></li>
                                                    </ul>
                                            </div>
									</div>
								</dd>
								...
								<dt></dt>
								<dd class="btn"><a class="" href="#"><img alt="수정하기" src="/webroot/images/newsnevent/btn_event_change.png"/></a>
									<a class="" href="#"><img alt="삭제하기" src="/webroot/images/newsnevent/btn_event_del.png"/></a></dd>
						</dl>
				</div>
		</div>
		<div class="info">
